  ...
  return (
    <div style={{
      ...
      <div onClick={(e) => e.stopPropagation()} style={{
        ...
        border: "1px solid #1a2744", borderRadius: "16px", padding: "40px",
        ...
        <div style={{ display: "flex", marginBottom: "28px", border: "1px solid #1a2744", borderRadius: "8px", overflow: "hidden" }}>
          {["login", "register"].map((t) => (
            <button key={t} onClick={() => { setTab(t); setError(""); }} style={{
              flex: 1, padding: "12px", background: tab === t ? "#00FF8715" : "transparent",
              border: "none", cursor: "pointer", color: tab === t ? "#00FF87" : "#4A5568",
              fontSize: "10px", letterSpacing: "3px", fontFamily: "'Courier New', monospace",
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "14px" }}>
          {tab === "register" && (
            <input name="full_name" placeholder="FULL NAME" value={form.full_name} onChange={handle} style={inputStyle} />
          )}
  ...
  return (
    <div style={{
      ...
      <div style={{
        background: "linear-gradient(145deg, #0A0F1E, #0D1525)",
        border: "1px solid #1a2744", borderRadius: "16px", padding: "40px",
        width: "100%", maxWidth: "500px", fontFamily: "'Courier New', monospace",
        boxShadow: "0 0 60px rgba(0,255,135,0.08)",
      }}>
        <div style={{ textAlign: "center", marginBottom: "32px" }}>
        ...
        <div style={{ display: "flex", gap: "6px", marginBottom: "32px" }}>
          {ONBOARDING_QUESTIONS.map((_, i) => (
            <div key={i} style={{
              ...
              background: i <= step ? "#00FF87" : "#1a2744", transition: "background 0.3s",
            }} />
          ))}
        </div>
        <div style={{ fontSize: "9px", color: "#4A5568", letterSpacing: "3px", marginBottom: "12px" }}>
          QUESTION {step + 1} OF {ONBOARDING_QUESTIONS.length}
        </div>
        <div style={{ fontSize: "16px", fontWeight: "900", color: "#E2E8F0", letterSpacing: "1px", marginBottom: "24px", lineHeight: 1.4 }}>
          {q.question}
        </div>
        <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
          {q.options.map((option) => (
            <button key={option} onClick={() => select(option)} style={{
              padding: "14px 20px",
              background: answers[q.id] === option ? "#00FF8715" : "#050810",
              border: `1px solid ${answers[q.id] === option ? "#00FF87" : "#1a2744"}`,
              borderRadius: "8px", cursor: "pointer",
              color: answers[q.id] === option ? "#00FF87" : "#718096",
        ...
        <div style={{ marginTop: "24px", fontSize: "9px", color: "#4A5568", textAlign: "center", letterSpacing: "2px" }}>
          YOUR ANSWERS PERSONALIZE YOUR PROGRAM LIBRARY
        </div>
      </div>
    </div>
  );
...
function ProgramCard({ program, onSelect }) {
  ...
  return (
    <div
      ...
      style={{
        background: hovered ? "linear-gradient(145deg, #0D1525, #111827)" : "linear-gradient(145deg, #080D1A, #0A0F1E)",
        border: `1px solid ${hovered ? color + "40" : "#1a2744"}`,
    ...
    >
      ...
      <div style={{
        ...
        fontSize: "8px", letterSpacing: "3px", color: color,
        marginBottom: "14px", background: `${color}10`,
      }}>
        {program.category?.toUpperCase() || "PROGRAM"}
      </div>
      <div style={{ fontSize: "15px", fontWeight: "900", letterSpacing: "2px", color: "#E2E8F0", marginBottom: "10px", lineHeight: 1.3 }}>
        {program.name}
      </div>
      <div style={{ fontSize: "10px", color: "#718096", lineHeight: "1.7", marginBottom: "18px" }}>
        {program.description}
      </div>
      <div style={{ display: "flex", gap: "16px", flexWrap: "wrap" }}>
        {[
          { label: "LEVEL", value: program.intensity || "Moderate" },
          { label: "DURATION", value: `${program.weeks} wks` },
          { label: "DAYS/WK", value: program.days_per_week },
          { label: "GENDER", value: program.gender || "Both" },
        ].map((m) => (
          <div key={m.label}>
...
function ProgramDetailModal({ program, onClose }) {
  ...
  return (
    <div style={{
      ...
      <div onClick={(e) => e.stopPropagation()} style={{
        background: "linear-gradient(145deg, #0A0F1E, #0D1525)",
        border: `1px solid ${color}40`, borderRadius: "16px", padding: "40px",
        maxWidth: "600px", width: "100%", fontFamily: "'Courier New', monospace",
        boxShadow: `0 0 60px ${color}15`, maxHeight: "90vh", overflowY: "auto",
      }}>
        <div style={{ fontSize: "8px", letterSpacing: "4px", color: color, marginBottom: "8px" }}>
          {program.category?.toUpperCase()}
        </div>
        <h2 style={{ fontSize: "22px", fontWeight: "900", letterSpacing: "2px", margin: "0 0 8px", color: "#E2E8F0" }}>
          {program.name}
        </h2>
        <p style={{ fontSize: "12px", color: "#718096", lineHeight: "1.8", marginBottom: "24px" }}>
          {program.description}
        </p>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr 1fr", gap: "10px", marginBottom: "24px" }}>
          {[
            ...
            { label: "INTENSITY", value: program.intensity },
            { label: "GENDER", value: program.gender },
          ].map((m) => (
            ...
            <div style={{ display: "flex", gap: "8px", flexWrap: "wrap" }}>
              {program.tags.map((tag) => (
                <span key={tag} style={{
                  ...
                  fontSize: "9px", color: color, letterSpacing: "1px",
                }}>{tag}</span>
              ))}
            </div>
          </div>
        ...
        <div style={{ display: "flex", gap: "12px" }}>
          <button style={{
            ...
            color: "#050810", fontWeight: "900", fontSize: "11px",
            letterSpacing: "3px", fontFamily: "'Courier New', monospace",
...
function Dashboard({ user, onLogout, onUpdateUser }) {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "linear-gradient(135deg, #050810 0%, #080D1A 100%)", fontFamily: "'Courier New', monospace", color: "#E2E8F0" }}>
      ...
      {selectedProgram && <ProgramDetailModal program={selectedProgram} onClose={() => setSelectedProgram(null)} />}

      <div style={{
        borderBottom: "1px solid #1a2744", padding: "20px 40px",
        display: "flex", justifyContent: "space-between", alignItems: "center",
        background: "#05081099", backdropFilter: "blur(10px)",
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "20px" }}>
          <div style={{ textAlign: "right" }}>
            ...
            <div style={{
              fontSize: "9px", letterSpacing: "2px", color: "#00FF87",
              background: "#00FF8715", padding: "2px 8px", borderRadius: "4px",
              border: "1px solid #00FF8730", display: "inline-block", marginTop: "2px",
            }}>{user.tier?.toUpperCase() || "STARTER"}</div>
          </div>
      ...
      <div style={{ padding: "60px 40px 40px", maxWidth: "1200px", margin: "0 auto" }}>
        ...
        <h1 style={{
          fontSize: "clamp(28px, 4vw, 48px)", fontWeight: "900", letterSpacing: "3px", margin: "0 0 8px",
        ...
        <div style={{
          marginTop: "40px", background: "linear-gradient(145deg, #0D1525, #111827)",
          border: "1px solid #1a2744", borderRadius: "12px", padding: "28px 32px",
          display: "flex", alignItems: "center", justifyContent: "space-between",
          flexWrap: "wrap", gap: "20px",
        }}>
          <div>
            <div style={{ fontSize: "9px", letterSpacing: "3px", color: "#4A5568", marginBottom: "6px" }}>CURRENT TIER</div>
            <div style={{ fontSize: "22px", fontWeight: "900", letterSpacing: "3px", color: "#00FF87" }}>
              {user.tier?.toUpperCase() || "STARTER"}
            </div>
            <div style={{ fontSize: "10px", color: "#718096", marginTop: "4px" }}>
              {filteredPrograms.length} programs matched to your goals
            </div>
          </div>
          <div style={{ display: "flex", gap: "12px", flexWrap: "wrap" }}>
            <button onClick={() => setShowOnboarding(true)} style={{
              padding: "12px 20px", background: "transparent",
              border: "1px solid #00FF8730", borderRadius: "8px", cursor: "pointer",
              color: "#00FF87", fontSize: "10px", letterSpacing: "2px",
              fontFamily: "'Courier New', monospace",
            }}>RETAKE QUIZ →</button>
            <button style={{
              padding: "14px 28px", background: "linear-gradient(90deg, #00FF87, #00D4FF)",
              border: "none", borderRadius: "8px", cursor: "pointer",
              color: "#050810", fontWeight: "900", fontSize: "11px",
              letterSpacing: "3px", fontFamily: "'Courier New', monospace",
            }}>UPGRADE TIER →</button>
        ...
        <div style={{ marginTop: "40px", display: "flex", gap: "8px", flexWrap: "wrap" }}>
          {filters.map((f) => (
            <button key={f} onClick={() => setActiveFilter(f)} style={{
              padding: "8px 16px",
              background: activeFilter === f ? "#00FF8715" : "transparent",
              border: `1px solid ${activeFilter === f ? "#00FF87" : "#1a2744"}`,
              borderRadius: "20px", cursor: "pointer",
              color: activeFilter === f ? "#00FF87" : "#4A5568",
              fontSize: "9px", letterSpacing: "2px",
        ...
        <div style={{ marginTop: "30px" }}>
          ...
          {loading ? (
            <div style={{ textAlign: "center", padding: "60px", color: "#4A5568", letterSpacing: "3px", fontSize: "11px" }}>
              LOADING PROGRAMS...
            </div>
          ) : (
...
export default function HybridMatrix() {
  ...
  return (
    <div style={{
      ...
      fontFamily: "'Courier New', monospace", color: "#E2E8F0", overflowX: "hidden",
    }}>
      {authModal && <AuthModal mode={authModal} onClose={() => setAuthModal(null)} onSuccess={handleAuthSuccess} />}

      <nav style={{
        position: "fixed", top: 0, left: 0, right: 0, zIndex: 500, padding: "18px 40px",
        ...
        <div style={{ display: "flex", gap: "12px" }}>
          <button onClick={() => setAuthModal("login")} style={{
            padding: "9px 20px", background: "transparent", border: "1px solid #1a2744",
            borderRadius: "6px", cursor: "pointer", color: "#718096", fontSize: "9px",
            letterSpacing: "2px", fontFamily: "'Courier New', monospace",
          }}>LOGIN</button>
          <button onClick={() => setAuthModal("register")} style={{
            padding: "9px 20px", background: "linear-gradient(90deg, #00FF87, #00D4FF)",
            border: "none", borderRadius: "6px", cursor: "pointer",
            color: "#050810", fontSize: "9px", fontWeight: "900",
            letterSpacing: "2px", fontFamily: "'Courier New', monospace",
          }}>START FREE</button>
        </div>
      </nav>
      ...
      <div style={{
        ...
        <div style={{ position: "relative", zIndex: 1, textAlign: "center", maxWidth: "800px" }}>
          <div style={{
            display: "inline-block", fontSize: "9px", letterSpacing: "6px", color: "#00FF87",
            border: "1px solid #00FF8730", padding: "6px 18px", borderRadius: "4px",
            marginBottom: "32px", background: "#00FF8708",
          }}>SCIENCE-BASED · AI POWERED · BILINGUAL EN/ES</div>
          ...
          <p style={{ fontSize: "clamp(13px, 2vw, 16px)", color: "#718096", lineHeight: "1.8", maxWidth: "560px", margin: "0 auto 48px", letterSpacing: "1px" }}>
            Your body adapts to everything. Your program should too. AI-driven training built from real science.
          </p>
          <div style={{ display: "flex", gap: "14px", justifyContent: "center", flexWrap: "wrap" }}>
            <button onClick={() => setAuthModal("register")} style={{
              padding: "16px 36px", background: "linear-gradient(90deg, #00FF87, #00D4FF)",
              border: "none", borderRadius: "8px", cursor: "pointer",
              color: "#050810", fontWeight: "900", fontSize: "12px",
              letterSpacing: "3px", fontFamily: "'Courier New', monospace",
      ...
      <div style={{
        ...
        padding: "28px 40px", display: "flex", justifyContent: "center",
        gap: "clamp(30px, 6vw, 80px)", flexWrap: "wrap", background: "#05081080",
      }}>
        {STATS.map((s) => (
      ...
      <div id="programs" style={{ padding: "80px 40px", maxWidth: "1200px", margin: "0 auto" }}>
        <div style={{ marginBottom: "48px" }}>
          ...
          <h2 style={{ fontSize: "clamp(24px, 4vw, 40px)", fontWeight: "900", letterSpacing: "3px", margin: "0 0 14px", color: "#E2E8F0" }}>
            BROWSE FREE. TRAIN SMARTER.
          </h2>
          <p style={{ fontSize: "12px", color: "#4A5568", letterSpacing: "1px" }}>
            Sign up free. Answer 5 questions. We match you to the right program instantly.
          </p>
        </div>
        ...
        <div style={{
          marginTop: "60px", textAlign: "center", padding: "60px 40px",
          background: "linear-gradient(145deg, #0D1525, #111827)",
          borderRadius: "16px", border: "1px solid #1a2744", position: "relative", overflow: "hidden",
        }}>
          <div style={{ fontSize: "9px", letterSpacing: "5px", color: "#00FF87", marginBottom: "16px" }}>GET STARTED TODAY</div>
          <h3 style={{ fontSize: "clamp(20px, 3vw, 32px)", fontWeight: "900", letterSpacing: "2px", margin: "0 0 14px", color: "#E2E8F0" }}>
            YOUR PROGRAM. YOUR RESULTS.
          </h3>
          <p style={{ fontSize: "12px", color: "#718096", marginBottom: "32px", letterSpacing: "1px" }}>
            Answer 5 questions. We match you to the right program instantly.
          </p>
          <button onClick={() => setAuthModal("register")} style={{
            padding: "16px 40px", background: "linear-gradient(90deg, #00FF87, #00D4FF)",
            border: "none", borderRadius: "8px", cursor: "pointer",
            color: "#050810", fontWeight: "900", fontSize: "12px",
            letterSpacing: "3px", fontFamily: "'Courier New', monospace",
      ...
      <div style={{
        borderTop: "1px solid #1a2744", padding: "32px 40px",
        display: "flex", justifyContent: "space-between", alignItems: "center",
